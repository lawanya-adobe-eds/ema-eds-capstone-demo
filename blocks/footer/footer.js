...
// (wknd-icon-font); we substitute standard, portable inline SVGs keyed by the
// social network detected from the link href/label.
const SOCIAL_ICONS = {
  // Bare "f" letterform (no enclosing circle) to match the source's
  // wknd-icon-font Facebook glyph, which is a standalone dark "f".
  facebook: '<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M15.4 3.5v3.2h-1.9c-.7 0-1.1.5-1.1 1.2v2.2h3l-.4 3.2h-2.6v9h-3.4v-9H6.6v-3.2h2.4V7.4c0-2.4 1.5-3.9 3.9-3.9h2.5z"/></svg>',
...
export default async function decorate(block) {
  // Resolve the footer fragment path for both local dev (/content) and production.
  ...
  // Tag the four content sections for styling.
  ...
  // Replace social link text with inline SVG icons.
